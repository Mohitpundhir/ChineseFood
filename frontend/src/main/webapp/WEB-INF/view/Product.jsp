...
<h2 Align="center">Add Product </h2>
 <div class="container">
	<spring:form action="${pageContext.request.contextPath}/AdminaddProduct" modelAttribute="dat" method="post">
	...
	<spring:input type="text" id="pname" class="form-control" path="productName"/><spring:errors path="productName"/>
	</div>
	<div class="form-group">
...
<td>${dot.quantity}</td>
<td>${dot.price }</td> 
<td><a href="<c:out value="AdmineditProduct/${dot.productId}"></td>></c:out>">Edit</a>
<td><a href="<c:out value="AdmindeleteProduct/${dot.productId}"></td>></c:out>">Delete</a>
</tr>
